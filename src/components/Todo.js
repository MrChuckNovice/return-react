  ...
  const editingTemplate = (
    <form className="stack-small" onSubmit={handleSubmit}>
      ...
      <div className="btn-group">
        <button type="button" className="btn todo-cancel" onClick={() => setEditing(false)}>Annuler
        <span className="visually-hidden">renommer {props.name}</span>
        </button>
        <button className="submit" className="btn btn__primary todo-edit">
          enregistrer
  ...
  const viewTemplate = (
    <div className="stack-small">
      <div className="c-cb">
        ...
        id ={props.id}
        type="checkbox"
        defaultCheckbox={props.completed}
...
// defaultChecked={props.completed} va cocher uniquement la case qui est egal a true 